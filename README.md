...
IEEE Trans. Pattern Anal. Machine Intell. (TPAMI), 2023. [Code](https://github.com/pld-group/V2E2V), [Code for data generation](https://github.com/lsying009/V2E_Generation),  [Code for evaluation](https://github.com/lsying009/CISTA-EVREAL)
    ...
    *[Convolutional ISTA Network with Temporal Consistency Constraints for Video Reconstruction from Event Cameras](https://doi.org/10.1109/ICASSP43922.2022.9746331)*, IEEE Int. Conf. Acoust., Speech, Signal Proc. (ICASSP), 2022. [Code](https://github.com/pld-group/V2E2V)
    - <a name="Liu24arxiv"></a>Liu, S., Dragotti, P.L., *[Enhanced Event-Based Video Reconstruction with Motion Compensation](https://arxiv.org/pdf/2403.11961)*,  arxiv, 2024. [Code](https://github.com/lsying009/CISTA-Flow)
