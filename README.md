...
- [Chaney et al., CVPRW 2023](#Chaney23M3ED), *M3ED: Multi-Robot, Multi-Sensor, Multi-Environment Event Dataset*
...
- <a name="Chaney23M3ED"></a>Chaney, K., Cladera, F., Wang, Z., Bisulco, A., Hsieh, M.A., Korpela, C., Kumar, V., Taylor, C.J. and Daniilidis, K.,
*[M3ED: Multi-Robot, Multi-Sensor, Multi-Environment Event Dataset](https://m3ed.io/)*,  
Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR) Workshops, pp. 4015-4022, 2023.
