...
- <a name="gehrig22arxiv"></a>D. Gehrig, D. Scaramuzza,  
*[Are High-Resolution Cameras Really Needed?](https://arxiv.org/abs/2203.14672)*,  
arXiv, 2022. [PDF](https://rpg.ifi.uzh.ch/docs/arxiv22_Gehrig.pdf), [YouTube](https://youtu.be/HV9_FhS-f88), [code](https://uzh-rpg.github.io/eres/).  
...
- <a name="dietsche21iros"></a>A. Dietsche, G. Cioffi, J. Hidalgo-Carrio, D. Scaramuzza,  
*[Powerline Tracking with Event Cameras](https://arxiv.org/abs/2108.00515)*,  
...
- <a name="messikommer23cvpr"></a>Nico Messikommer*, Carter Fang*, Mathias Gehrig, Davide Scaramuzza,  
...
- <a name="Gehrig22arxiv_flow"></a>Mathias Gehrig, Manasi Muglikar, Davide Scaramuzza,  
*[Dense Continuous-Time Optical Flow from Events and Frames](https://arxiv.org/abs/2203.13674)*,  
arXiv, 2022. [PDF](https://rpg.ifi.uzh.ch/docs/Arxiv22_Gehrig_Flow.pdf).  
...
- <a name="tulyakov22cvpr"></a>S. Tulyakov, A. Bochicchio, D. Gehrig, S. Georgoulis, Y. Li, D. Scaramuzza,  
...
- <a name="messikommer22cvprw"></a>N. Messikommer*, S. Georgoulis*, D. Gehrig, S. Tulyakov, J. Erbach, A. Bochicchio, Y. Li, D. Scaramuzza,  
*[Multi-Bracket High Dynamic Range Imaging with Event Cameras](https://arxiv.org/abs/2203.06622)*,  
IEEE Conference on Computer Vision and Pattern Recognition Workshop (CVPRW), 2022. [PDF](https://rpg.ifi.uzh.ch/docs/CVPRW22_Messikommer.pdf), [YouTube](https://youtu.be/fw9-gNg6cM8).  
...
- <a name="muglikar23cvpr"></a>Manasi Muglikar, Leonard Bauersfeld, Diederik P. Moeys, Davide Scaramuzza,  
*[Event-based Shape from Polarization](https://arxiv.org/abs/2301.06855)*,  
IEEE/RSJ Int. Conf. Intelligent Robots and Systems (IROS), 2021. [PDF](https://rpg.ifi.uzh.ch/docs/CVPR23_Muglikar.pdf), [YouTube](https://youtu.be/sF3Ue2Zkpec), [code](https://github.com/uzh-rpg/ESfP).  
...
- <a name="mahlknecth22ral"></a>F. Mahlknecht, D. Gehrig, J. Nash, F. M. Rockenbauer, B. Morrell, J. Delaune and D. Scaramuzza,  
*[Exploring Event Camera-based Odometry for Planetary Robots](https://arxiv.org/abs/2204.05880)*,  
...
- <a name="sun22eccv"></a>Z. Sun*, N. Messikommer*, D. Gehrig, D. Scaramuzza,  
*[ESS: Learning Event-based Semantic Segmentation from Still Images](https://arxiv.org/abs/2203.10016)*,  
...
- <a name="gehrig23cvpr"></a>Mathias Gehrig and Davide Scaramuzza,  
...
IEEE Conf. Computer Vision and Pattern Recognition Workshops (CVPRW), 2022. [PDF](https://arxiv.org/abs/2204.03355), [Supp. Video](https://drive.google.com/file/d/1X4OviJTxTUbi2W0zQYKG3qqtEUf98a0p/view?usp=sharing), [Code](https://github.com/AlbertoSabater/EventTransformer).
  ...
  *[Event Transformer+. A multi-purpose solution for efficient event data processing](https://arxiv.org/abs/2211.12222)*,  
  arXiv, 2022.
- <a name="messikommer22ral"></a>N. Messikommer, D. Gehrig, M. Gehrig, D. Scaramuzza,  
*[Bridging the Gap between Events and Frames through Unsupervised Domain Adaptation](https://arxiv.org/abs/2109.02618)*,  
...
- <a name="schaefer22cvpr"></a>S. Schaefer*, D. Gehrig*, D. Scaramuzza,  
*[AEGNN: Asynchronous Event-based Graph Neural Networks](https://arxiv.org/abs/2203.17149)*,  
IEEE Conference of Computer Vision and Pattern Recognition (CVPR), 2022. [PDF](https://rpg.ifi.uzh.ch/docs/CVPR22_Schaefer.pdf), [YouTube](https://youtu.be/opbFE6OsAeA), [code](https://github.com/uzh-rpg/aegnn/).  
- <a name="gehrig22arxiv_graph"></a>Daniel Gehrig, Davide Scaramuzza,  
*[Pushing the Limits of Asynchronous Graph-based Object Detection with Event Cameras](https://arxiv.org/abs/2211.12324)*,  
arXiv, 2022. [PDF](https://rpg.ifi.uzh.ch/docs/arXiv22_Gehrig.pdf).  
- <a name="aydin23arxiv"></a>Asude Aydin, Mathias Gehrig, Daniel Gehrig, Davide Scaramuzza,  
...
- <a name="forrai23icra"></a>Benedek Forrai*, Takahiro Miki*, Daniel Gehrig*, Marco Hutter, Davide Scaramuzza,  
...
- [Mahlknecht et al., RAL 2022](#mahlknecth22ral),  
...
- [Gehrig et al., RAL21](#MGehrig21ral): *DSEC: A Stereo Event Camera Dataset for Driving Scenarios*.  
